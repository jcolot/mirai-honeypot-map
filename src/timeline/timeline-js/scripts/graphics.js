 ...
 * @type Boolean
 */
//Timeline.Graphics.pngIsTranslucent = (!jQuery.browser.msie) || (jQuery.browser.version > 6);
if (!Timeline.Graphics.pngIsTranslucent) {
    Timeline.includeCssFile(document, Timeline.urlPrefix + "styles/graphics-ie6.css");
}
 ...
 *==================================================
 */
Timeline.Graphics._createTranslucentImage1 = function(url, verticalAlign) {
...
Timeline.Graphics._createTranslucentImage2 = function(url, verticalAlign) {
    var elmt = document.createElement("img");
 ...
 */
Timeline.Graphics.createTranslucentImage = Timeline.Graphics.pngIsTranslucent ?
    Timeline.Graphics._createTranslucentImage1 :
    Timeline.Graphics._createTranslucentImage2;

Timeline.Graphics._createTranslucentImageHTML1 = function(url, verticalAlign) {
    return "<img src=\"" + url + "\"" +
        (verticalAlign != null ? " style=\"vertical-align: " + verticalAlign + ";\"" : "") +
        " />";
};
Timeline.Graphics._createTranslucentImageHTML2 = function(url, verticalAlign) {
    var style = 
 ...
 */
Timeline.Graphics.createTranslucentImageHTML = Timeline.Graphics.pngIsTranslucent ?
    Timeline.Graphics._createTranslucentImageHTML1 :
    Timeline.Graphics._createTranslucentImageHTML2;
...
Timeline.Graphics.createBubbleForPoint = function(pageX, pageY, contentWidth, contentHeight, orientation) {
    ...
    bubble._div = div;
    bubble.close = function() { Timeline.WindowManager.popLayer(layer); }
