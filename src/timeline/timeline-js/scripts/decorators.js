...
Timeline.SpanHighlightDecorator.prototype.resize = function(startDate,endDate) {
    ...
    if (this._layerDiv != null) {
        ...
        this._layerDiv.firstChild.style.left = minPixel + "px";
        this._layerDiv.firstChild.style.width = (maxPixel - minPixel) + "px";
        }
};
